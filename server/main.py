...
from api import auth, projects, api_cases, ui_cases, api_test_cases, environments, test_runner, batch_runs, ws_batch, test_suites, scene_nodes, ai_generate, ai_skills, ui_recordings, ws_ui_record, ui_runner, ws_ui_run, ws_ui_preview, monkey, ws_monkey, dashboard, ui_test_suites, scheduled_tasks
...
app.include_router(scheduled_tasks.router, prefix=f"{settings.API_V1_STR}/scheduled-tasks", tags=["scheduled-tasks"])
